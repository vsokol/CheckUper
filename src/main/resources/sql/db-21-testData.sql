...
insert into request (id, name, status, dt_start, dt_end, dt_comleted, customer_id, executor_id, descr)
values (1002, 'Помочь по хозяйству', 'TODO', TIMESTAMP WITH TIME ZONE '2021-02-10 10:00:00+03', TIMESTAMP WITH TIME ZONE '2021-02-10 13:30:00+03', null, null, null, 'Помочь по хозяйству');
insert into request (id, name, status, dt_start, dt_end, dt_comleted, customer_id, executor_id, descr)
values (1003, 'Покупать хлеб', 'IN_PROGRESS', TIMESTAMP WITH TIME ZONE '2020-12-15 10:00:00+03', TIMESTAMP WITH TIME ZONE '2020-12-10 19:00:00+03', null, 1003, 1002, 'Покупать каждый день булку хлеба и пакет молока');
insert into request (id, name, status, dt_start, dt_end, dt_comleted, customer_id, executor_id, descr)
